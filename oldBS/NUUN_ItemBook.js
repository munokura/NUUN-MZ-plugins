...
The initial and final ' and " characters are optional, but they may not be
displayed correctly in some strings. Please do not include them when entering
tags in the memo field.

This plugin requires NUUN_Base version 1.3.0 or later.

Update History
2023/12/29 Ver. 1.6.4
Fixed a bug when the item category name was not set.
2023/9/10 Ver. 1.6.3
Fixed an issue that caused an error to appear when an individual image folder
was not specified.
2023/4/23 Ver. 1.6.2
Added a feature to set the total number of entries (excluding items, weapons,
and armor) for the encyclopedia completion rate and registration count.
2023/3/25 Ver. 1.6.1
Added the ability to specify key bindings for page switching. (A separate
plugin that allows key binding is required.)
2023/2/25 Ver. 1.6.0
Added a field that displays additional ability values and special ability
values.
2023/1/25 Ver. 1.5.1
Fixed an issue where an error occurred when opening the Item Encyclopedia when
...
2023/1/9 Ver. 1.5.0
Added the ability to set item, weapon, and armor images from plugin
parameters.
2023/1/7 Ver. 1.4.5
...
2022/2/3 Ver. 1.4.3
Fixed an issue that caused the item list to display incorrectly.
2021/12/12 Ver. 1.4.2
Added a feature to set the width of the main window (displaying item
information).
...
of registered items, and all items, weapons, and armor in the completion rate
window.
2021/9/28 Ver. 1.3.0
...
Added a feature to display numbers in category order.
Added the ability to specify a background image.
2021/9/2 Ver. 1.2.4
Fixed an issue where the coordinates of individual item images were not being
set.
2021/8/30 Ver. 1.2.3
Fixed an issue that caused an error when the item item settings in the plugin
...
Added a feature to display images.
August 22, 2021 Ver. 1.1.0
Added a feature to set custom item categories.
August 13, 2021 Ver. 1.0.1
Fixed an issue that caused book numbers to be displayed incorrectly.
...
@value 1
@option Display the item number and fill in the blanks with zeros.
@value 2
...
const ShowCommand = eval(parameters['ShowCommand'] || 'true');//
