...
Implements an item encyclopedia.
This plugin allows you to freely customize the display of items, weapons, and
armor.

Page Item Settings
Items for each page are configured in "Item Item Settings," "Weapon Item
Settings," and "Armor Item Settings."
Item settings can be configured using the numeric values in parentheses next
to the item list.

[Name Settings]
You can set any name other than the item name.
If left blank, the name set in the database and within this plugin will be
displayed.

[System Item Text Color Settings]
Specify the text color for the name.

[Parameter Evaluation Formula Settings]
Enter the evaluation formula. Must be entered for original parameters.
[item] allows you to obtain item data.
If left blank for parameters other than original parameters, they will be
automatically referenced.
Reference Parameters
[item] - Item Data

[Description Field Settings]
For the description field, enter any string in the plugin parameter
"Description Field Tag Name." Please note that some strings may not be usable.
If you enter "desc1" in the memo field for an item, weapon, or armor, when you
enter "desc1: aaaaaa" in the description field tag name, "aaaaaaa" will be
displayed in the item.

[X Display Position]
Specify the column to display.

[Y Display Position]
Specify the row to display.

[X Coordinate Setting]
Relative coordinate shift from the display position.

[Y Coordinate Setting]
Relative coordinate shift from the display position.

[Item Width Setting]
Specify the width. If not specified, it will be automatically adjusted.

[Item Display Mode]
Displays items across multiple columns.

[System Item Width]
Specify the display width of the system text.

[Name and Item Name Display Position]
Specify the position of the name and item name text.

[Unit]
Set the unit to add to the suffix. Can be set for original parameters and
success rate.

[Content Background Display]
Set whether to display a black background (default) or a table.
You can set the following: stats, number of items held, maximum number of
items held, price, original parameters, when available, consumption, speed
modifier, TP gained, weapon type, armor type, and equipment type.

[Description, Individual Image Tag Name]
Enter any string you like. Some strings may not be usable, so if they are,
enclose them in quotation marks ('') and they may be displayed.
Item, weapon, and armor memo field
<[tag]:[text]> Description text
[tag]: Description tag name [text]: Display text. You can display as many
lines as you like by adding line breaks, so you can add your own items.
<desc1:ああああ> "ああああ" will be displayed in items tagged with desc1.
To display text, enter <desc1:[text]>.

[Common Image]
Specify a common image to be displayed for all items, weapons, and armor.

[Maximum Image Height]
Adjusts the image display size to the specified number of lines. The default
is 8 lines, so the size will be adjusted if the height exceeds 8 lines.
This can be set using the common image or individual item image.

Displays individual images for items, weapons, and armor.
Item, weapon, and armor memo field.
<[tag]:[img],[x],[y]> Displays individual item images.
[tag]: Tag name set in the description field or individual image tag name.
[img]: Image path (without extension).
If the individual image folder is 'pictures', enter the file directly under
im/pictures without the extension.
If retrieving from a subfolder, enter the subfolder name as well. Example:
'items/tankobu'.
[x]: x coordinate (relative).
[y]: y coordinate (relative).
To specify multiple images, set only the number of images you want to display
in the item list, and then set different names in the description field or
individual image tag name.

Item images can also be set using the Item Image Settings, Weapon Image
Settings, and Armor Image Settings plugin parameters.
In this case, the image will be displayed if the individual image (101) is
selected in the item settings.
If the above tags are entered, the tags will take priority.

Set a custom category for an item
Item, weapon, or armor memo field
<[categorytag]:[categorykey]> Enter the category of the item to display.
[categorytag]: The tag name set in "Category Tag Name"
[categorykey]: The category key
allItem: All items, including key items
allItems: All items, weapons, and armor
The ' and " characters at the beginning and end of the text are optional, but
they may not be displayed correctly for some strings.
Do not add them when entering tags in the memo field.

This plugin requires NUUN_Base version 1.3.0 or later.

Update History
June 14, 2025 Ver. 1.6.6
Fixed a bug that prevented categories from being displayed if there was less
than 1 category.
October 12, 2024 Ver. 1.6.5
Fixed a conflict with some plugins.
December 29, 2023 Ver. 1.6.4
Fixed a bug when item category names were not set.
September 10, 2023 Ver. 1.6.3
Fixed an issue that caused an error to appear when an individual image folder
was not set.
April 23, 2023 Ver. 1.6.2
Added a feature to set the total number of items, weapons, and armor
registered in the encyclopedia completion rate and registration count,
excluding items, weapons, and armor.
March 25, 2023 Ver. 1.6.1
Added a feature to specify key assignments for page switching. (A separate
plugin that allows key assignments is required.)
February 25, 2023 Ver. 1.6.0
Added a field to display additional ability values and special ability values.
January 25, 2023 Ver. 1.5.1
Fixed an issue that caused an error when opening the item encyclopedia when
only one item category was set in the database.
Changed the specifications for item categories and item encyclopedia
categories separately.
Fixed an issue where weapon names were not applied.
January 9, 2023 Ver. 1.5.0
Added a feature to set images for items, weapons, and armor from plugin
parameters.
January 7, 2023 Ver. 1.4.5
Changed the specifications for the original parameters in item settings. (Only
the original parameters must be reset.)
Processing fixes.
July 24, 2022 Ver. 1.4.4
Fixed an issue where weapons and armor were not displayed.
2022/2/3 Ver. 1.4.3
Fixed an issue where the item list would display incorrectly.
2021/12/12 Ver. 1.4.2
Added a feature to set the width of the main window (displays item
information).
2021/11/11 Ver. 1.4.1
Slightly changed the background setting method.
The system text color for each item now supports color codes.
2021/11/3 Ver. 1.4.0
Added a feature to display the completion rate (items, weapons, armor), number
of registered items/total items, weapons, and armor in the completion rate
window.
2021/9/28 Ver. 1.3.0
Added a feature to assign the encyclopedia completion rate and number of
registered items to variables in the plugin command.
Added a feature to display the number display in category order.
Added a feature to specify a background image.
2021/9/2 Ver.1.2.4
Fixed an issue where coordinates were not being set for individual item
images.
August 30, 2021 Ver.1.2.3
Fixed an issue where an error would occur if the item item settings in the
plugin parameters were left at their default settings.
August 28, 2021 Ver.1.2.2
Fixed an issue where category keys were not reflected.
August 28, 2021 Ver.1.2.1
Fixed an issue where an error would occur when opening the item encyclopedia
with the common image left blank.
August 27, 2021 Ver.1.2.0
Added the ability to display images.
August 22, 2021 Ver.1.1.0
Added the ability to set custom item categories.
August 13, 2021 Ver.1.0.1
Fixed an issue where book numbers would display incorrectly.
Added a feature to hide certain weapon and armor types.
August 11, 2021 Ver.1.0.0
First version

@param RequireFiles
@text Files that should not be deleted during deployment
@desc When specifying an image from the memo field, specify the material file that you want to prohibit from being deleted during deployment.
@type file[]
@dir img/
...
@param WindowMode
@text Selection screen window position
@desc Specify the display position of the item and category selection screen.
@type select
@default 0
@option left side display
@value 0
@option Right side display
@value 1
@parent BasicSetting

@param NumberType
@text Item number display
@desc Displays the item number.
@type select
@default 0
@option No item number displayed
@value 0
@option Shows the item number.
@value 1
@option Display the item number and fill in with zeros.
@value 2
@parent BasicSetting

@param RegistrationTiming
@text Registration timing
@desc Timing of encyclopedia registration.
@type select
@default 0
@option At the time of acquisition
@value 0
...
@param UnknownData
@text Unconfirmed Item Name
@desc Unconfirmed index name. If you enter only one character "?", it will be replaced with "?" depending on the number of characters in the name.
@type string
@default ？
@parent BasicSetting
...
@desc The numbers are displayed in the order of each category.
@type boolean
@default false
@parent BasicSetting

@param ItemBookImgList
@text Item image settings
@desc Configure the item.
@type struct<ItemBookList>[]
@parent BasicSetting

@param WeaponItemBookImgList
@text Weapon Image Settings
@desc Configure the weapon.
@type struct<WeaponItemBookList>[]
@parent BasicSetting

@param ArmorItemBookImgList
@text Armor image settings
@desc Set up the armor.
...
@param BookWidth
@text Picture book width
@desc Width of the main encyclopedia window (0 is 2/3 of the screen).
@type number
@default 0
@min 0
...
@text Background image display
@desc Displays the background image of the picture book.
@type boolean
@default false
@parent BackGround
...
@desc Set the item category. If not set, the normal item category will be displayed.
...
@desc Specify the name of the tag to be entered in the memo field to identify the item category.
@type string
@default 'CategoryType'
@parent Category

@param PercentWindow
@text Readiness window settings
@default ------------------------------

@param PercentWindowVisible
@text Completion window display
@desc Display the completion window.
@type boolean
@default true
@parent PercentWindow

@param PercentContent
@text Display item settings
@desc Set the display items in the completion window.
...
@desc Completeness window update frame
@type number
@default 100
@min 0
@max 999999
...
@text Completion rate registration number item application
@desc The item will be applied to the encyclopedia completion rate and number of encyclopedia entries.
@type boolean
@default true
@parent PercentWindow

@param AllPercentWeapon
@text Completion rate registration number weapon application
@desc Weapons are applied to the encyclopedia completion rate and encyclopedia registration count.
@type boolean
@default true
@parent PercentWindow

@param AllPercentArmor
@text Completion rate registration number Armor application
@desc Armor is now applied to the encyclopedia completion rate and number of encyclopedia entries.
@type boolean
@default true
@parent PercentWindow
...
@desc Added the Item Encyclopedia to the menu commands.
@type boolean
@default false
@parent CommandData
...
@param PageData
@text Display page settings
@default ------------------------------

@param ItemPageSetting
@text Item settings
@desc Item item settings.
...
@text Weapon item settings
@desc Weapon item settings.
...
@param NoWeaponType
@text Hidden weapon types
@desc Weapon type IDs to hide. (Multiple selections allowed)
@type combo[]
@default 0
@parent PageData

@param ArmorPageSetting
@text Armor item settings
@desc Armor item settings.
...
@param NoArmorType
@text Armor types not displayed
@desc Armor type IDs to hide. (Multiple selections allowed)
@type combo[]
@default 0
@parent PageData

@param PageCols
@text Maximum columns displayed on page
@desc Maximum visible columns on a page.
@type number
@default 1
@min 1
@parent PageData
...
@param ContentCols
@text Number of information item columns
@desc Number of columns of information (common to all)
@type select
@default 2
@option 2 rows
@value 2
...
@text Open the item encyclopedia
@desc Open the Item Guide.

@command ItemBookInfoAdd
@text Adding items
@desc Add the item to the book.
@arg itemId
@desc Specify the item ID.
@type item
@default 0

@command WeaponBookInfoAdd
@text Add weapon
@desc Add weapons to your inventory.
@arg itemId
@desc Specify the weapon ID.
@type weapon
@default 0

@command ArmorBookInfoAdd
@text Added armor
@desc Add the armor to your inventory.
@arg itemId
@desc Specify the armor ID.
@type armor
@default 0

@command ItemBookInfoRemove
@text Item deletion
@desc Removes the item from the book.
@arg itemId
@desc Specify the item ID.
@type item
@default 0
...
@text Weapon removal
@desc Remove the weapon from the inventory.
@arg itemId
@desc Specify the item ID.
@type item
@default 0
...
@text Delete Armor
@desc Removes the armor from the catalog.
@arg itemId
@desc Specify the armor ID.
@type armor
@default 0
...
@text Completed the illustrated book
@desc Complete the picture book.

@command ItemBookCompleteness
@text Pokédex completion rate acquisition
@desc Assign the encyclopedia completion rate to a variable.
@arg VariableId
@desc variable
@type variable
@default 0
...
@text Obtaining the completion rate of the Pokédex item
@desc Assign the item completion rate of the encyclopedia to a variable.
@arg VariableId
@desc variable
@type variable
@default 0
...
@text Obtaining the encyclopedia weapon completion rate
@desc Assign the weapon completion rate from the encyclopedia to a variable.
@arg VariableId
@desc variable
@type variable
@default 0
...
@text Acquire the complete rate of the illustrated armor
@desc Assign the armor completion rate from the encyclopedia to a variable.
@arg VariableId
@desc variable
@type variable
@default 0
...
@text Obtaining the number of encyclopedia entries
@desc Assign the number of all items (including weapons and armor) registered in the encyclopedia information to a variable.
@arg VariableId
@desc variable
@type variable
@default 0
...
@text Get the number of registered items in the encyclopedia
@desc Assign the number of items registered in the encyclopedia information to a variable.
@arg VariableId
@desc variable
@type variable
@default 0
...
@text Obtain the number of weapons registered in the encyclopedia
@desc Assign the number of weapons registered in the encyclopedia information to a variable.
@arg VariableId
@desc variable
@type variable
@default 0
...
@text Acquire the number of registered armor in the encyclopedia
@desc Assign the number of armor registered in the encyclopedia information to a variable.
@arg VariableId
@desc variable
@type variable
@default 0
...
@param displayData
@text Display items
@desc The list item to display.
@type struct<ItemPageListData>[]
@parent ListData

@param PageName
@text Page Name
@desc Set the name of the page.
@type string

@param PageBackGroundId
@text Background Image Id
@desc Specifies the background image. If 0, the image number 1 in the list will be displayed.
@type number
@default 1
*/
...
@param ItemImg
@text Item image
@desc Specifies the image file name for the item.
@type file
@dir img/
...
@param ItemImg
@text Weapon Images
@desc Specifies the weapon image file name.
@type file
@dir img/
...
@param Item
@text Armor
@desc Specify the armor.
@type armor

@param ItemImg
@text Armor images
@desc Specify the image file name of the armor.
@type file
@dir img/
...
@param paramName
@text name
@desc Set the name of the item to be displayed.
@type string
@parent BasicSetting
...
@option No display
@value 0
@option Item name (2) to (7) (9) (11)
@value 1
@option Book Number (2) to (7) (9)
@value 2
@option Number of possessions (1) to (10)
@value 3
@option Maximum number of possessions (1) to (10)
@value 4
@option Price (1) to (10)
@value 5
@option Original parameters (1) to (10) (15) (16)
@value 8
@option Description fields (1) to (7) (9) (12)
@value 9
@option When available (1) to (10)
@value 10
@option Consumption (1) ~ (10)
@value 11
@option Speed correction (1) to (10)
@value 12
@option Success rate(1)～(10)(15)
@value 13
@option Profit TP(1)～(10)
@value 14
@option Name only (2) to (7) (9)
@value 51
@option Lines (2) to (7) (9)
@value 52
@option Number of acquisitions (not yet implemented)
@value 53
@option Number of uses (not implemented)
@value 54
@option Images (common images) (2) to (7) (9) (13) (14)
@value 100
@option Images (individually specified images) (2) to (7) (9) (12) (14)
@value 101
@parent BasicSetting

@param DetaEval
@text Parameter evaluation formula (1)
@desc Set the parameter evaluation formula.
@type combo
@option '$gameVariables.value(0); // Game Variables
@parent BasicSetting

@param NameColor
@text System item text color (2)
...
@param X_Position
@text X display column position (3)
...
@param Y_Position
@text Y display line position (4)
...
@param ItemWidth
@text Item width (7)
@desc Item width (automatic at 0)
@type number
@default 0
@min 0
@parent BasicSetting
...
@param WideMode
@text Item display mode (9)
@desc Item Display Mode
@type select
@default 1
@option 1 column display
@value 1
@option 2 column display
@value 2
@option 3-column display (only when the number of display columns is 3)
@value 3
@parent BasicSetting

@param Back
@text Content background display(10)
...
@param nameSetting
@text Name and item name settings

@param namePosition
@text Name, item name display position (11)
@desc Specify the display position of the name and item name
@type select
@default "left"
@option left
@value "left"
...
@param textSetting
@text Description field settings

@param textMethod
@text Description field, individual image tag name (12)
@desc Tag name to link to description field and image (individually specified image)
@type string
@parent textSetting
...
@param ImgMaxHeight
@text Maximum image height (14)
@desc Maximum image height (specified in lines)
@type number
@default 8
@min 0
@parent ImgSetting
...
@option MP(1)～(10)
@value 21
@option Attack Power (1) to (10)
@value 22
@option Defense power (1) ~ (10)
@value 23
@option Magic power (1) ~ (10)
@value 24
@option Magic defense (1) ~ (10)
@value 25
@option Agility(1)～(10)
@value 26
@option Luck (1) to (10)
@value 27
@option Weapon Type (1) to (10)
@value 30
@option Equipment type (1) to (10)
@value 32
@option Name only (2) to (7) (9)
@value 51
@option Lines (2) to (7) (9)
@value 52
@option Number of acquisitions (not implemented)
@value 53
@option Accuracy rate(1)～(10)(16)
@value 60
@option Evasion rate (1) ~ (10) (16)
@value 61
@option Attention rate(1)～(10)(16)
@value 62
@option Critical avoidance rate (1)-(10)(16)
@value 63
@option Magic evasion rate (1) ~ (10) (16)
@value 64
@option Magic reflectance (1) - (10) (16)
@value 65
@option Counterattack Rate (1) to (10) (16)
@value 66
@option HP regeneration rate (1) - (10) (16)
@value 67
@option MP playback rate (1) - (10) (16)
@value 68
@option TP playback rate(1)～(10)(16)
@value 69
@option Target Rate (1) to (10) (16)
@value 70
@option Defense Effectiveness Rate (1) to (10) (16)
@value 71
@option Recovery Rate (1) to (10) (16)
@value 72
@option Medicine knowledge (1)-(10)(16)
@value 73
@option MP consumption rate (1) ~ (10) (16)
@value 74
@option TP Charge Rate (1) to (10) (16)
@value 75
@option Physical Damage Rate (1) to (10) (16)
@value 76
@option Magic Damage Rate (1) to (10) (16)
@value 77
@option Floor Damage Rate (1) to (10) (16)
@value 78
@option Experience Gain Rate (1) to (10) (16)
@value 79
@option Images (common images) (2) to (7) (9) (13) (14)
@value 100
@option Images (individually specified images) (2) to (7) (9) (12) (14)
...
@param ImgData
@text Common images (13)
@desc Specify the common image file name.
@type file[]
@default []
@dir img/
@parent ImgSetting
...
@type select
@default 0
@option Pokédex completion rate
@value 0
@option Pokédex item completion rate
@value 1
@option Encyclopedia weapon completion rate
@value 2
@option Pokédex Armor Completion Rate
@value 3
@option Number of registered items in the encyclopedia (number of registered items/all items, weapons, and armor)
@value 10
@option Number of registered encyclopedia items (number of registered items/total items)
@value 11
@option Number of weapons registered in the encyclopedia (number of registered weapons/total weapons)
@value 12
@option Number of registered armor in the encyclopedia (number of registered armor/total armor)
@value 13
@parent nameSetting
*/
...
@param CategoryKey
@text Category Key
@desc Set the category key (only enter the first one).
@type combo[]
@option 'item'
@option 'allItem'
@option 'keyItem'
...
/*~struct~WeaponPageSettingData:ja
...
/*~struct~ArmorPageSettingData:ja
