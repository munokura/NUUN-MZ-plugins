...
To change the coordinate position of each status, set "Change coordinates of
XX" for each item to true.

Set only the items you want to display.
If even one item is set in the Display Status Settings, this setting will be
applied.
The Display Status setting allows you to customize the status displayed in the
Actor Status.

Custom Parameter, Custom Parameter (Dynamic)
In "Evaluation Expression or String A," enter the expression to display in
JavaScript.
this._battler: Actor Game Data
this._battler.actor(): Actor System Data

Custom Gauge
In "Evaluation Expression or String A," enter the current value in JavaScript.
In "Evaluation Expression or String B," enter the maximum value in JavaScript.
this._battler: Actor Game Data
this._battler.actor(): Actor System Data

State, State 2
In "Evaluation Expression or String A," enter the state ID to display.
In "Evaluation Expression or String B," enter the buff ID to display.

Image
In "Evaluation Expression or String A," enter the display condition in
